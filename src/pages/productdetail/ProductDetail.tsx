        ...
        <>
            <main className="bg-[#e2e4eb] py-5">
                ...
                <section className="bg-white rounded-xl px-4 md:px-6 lg:px-[30px] py-6 md:py-8 lg:py-[30px] shadow-sm mb-4">
                    {/* Tabs */}
                    <div className="flex flex-wrap gap-4 md:gap-[30px] text-[16px] md:text-[18px] mb-6 md:mb-8">
                        <Link to="#" className="text-black font-bold">
                            Description
                        </Link>
                        <Link to="#" className="text-[#666666] font-normal">
                            Reviews [5]
                        </Link>
                        <Link to="#" className="text-[#666666] font-normal">
                    ...
                    <div className="text-[14px]">
                        ...
                        <img
                            ...
                            alt=""
                        />
                        <h3 className="font-bold text-[16px] md:text-[18px] mb-3">
